                        ...
                        <Card className={`h-full border-2 transition-all duration-200 bg-white dark:bg-gray-900 ${isSelected ? 'border-primary ring-2 ring-primary/20 shadow-lg' : 'hover:border-gray-400 dark:hover:border-gray-600 border-transparent shadow-md'}`}>
                            ...
                            <CardContent className="pt-4">
                                <div
                                    className={
                                        isSelected
                                            ? `w-16 h-16 rounded-2xl flex items-center justify-center mb-6 mx-auto transition-all duration-200 ${chain.color} ring-2 ring-primary/40 ring-offset-2 ring-offset-white dark:ring-offset-gray-900 shadow-md`
                                            : 'w-16 h-16 rounded-2xl flex items-center justify-center mb-6 mx-auto transition-all duration-200 bg-gray-50 dark:bg-gray-800 shadow-inner'
                                    }
                                >
                                    <Icon className={`w-10 h-10 shrink-0 ${isSelected ? chain.textColor : (chain.iconColorUnselected ?? chain.textColor)}`} />
                                </div>
